...
- **Localized UI (FR / EN / DE / ES)**: the plugin automatically uses the Firefox interface language, or you can force one in the settings (Language).
...
- **Interface localisée (FR / EN / DE / ES)** : le plugin utilise automatiquement la langue de Firefox, ou vous pouvez en forcer une dans les paramètres (Langue).
